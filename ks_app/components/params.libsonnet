{
  ...
  components: {
    ...
    "cert-manager": {
      acmeEmail: 'provisioner@kubeflowgke.iam.gserviceaccount.com',
    ...
    "iap-ingress": {
      ...
      hostname: 'kubeflowapp.endpoints.kubeflowgke.cloud.goog',
      ingressSetupImage: 'gcr.io/kubeflow-images-public/ingress-setup:latest',
      ipName: 'kubeflowapp-ip',
